...
int main()
{
	...
	printf("Checking that worker thread 4 is running...\n");
	if (ftlh_atomic64_get(&ftlh_globals.threads[3].running) != 1) {
		printf("Worker thread 4 is not running.\n");
		return 108;
	}
